...
$free = json_encode($keyboard);
        file_get_contents("https://api.telegram.org/bot5167022773:AAHblmq9U_tTg3uXXHR5Ehfd7yjJFpQJkS4/editMessageText?chat_id=$cchatid2&text=$freecommands&message_id=$cmessage_id2&parse_mode=HTML&reply_markup=$free");
...
$islive = 'ON';
    ...
    'inline_keyboard' => [
        [
           ...
           ['text' => 'Others', 'callback_data' => 'others'], 
           ['text' => 'Buy', 'callback_data' => 'buy'], 
           // ['text' => 'Buy Now', 'url' => 'https://t.me/DeanTrampos'], 
           ['text' => 'Finalize', 'callback_data' => 'end']
        ]
        ]];
$freecommands = urlencode("<b>
...
Note-⟩ If you get any type of bugs in this bot please inform our team at @DeanTramposrobot</b>");
$free = json_encode($keyboard);
        file_get_contents("https://api.telegram.org/bot5167022773:AAHblmq9U_tTg3uXXHR5Ehfd7yjJFpQJkS4/editMessageText?chat_id=$cchatid2&text=$freecommands&message_id=$cmessage_id2&parse_mode=HTML&reply_markup=$free");
...
file_get_contents("https://api.telegram.org/bot5167022773:AAHblmq9U_tTg3uXXHR5Ehfd7yjJFpQJkS4/editMessageText?chat_id=$cchatid2&text=$finalize&message_id=$cmessage_id2&parse_mode=HTML");
}
...
THIS BOT IS MADE WITH ♥️ BY  <code>@DeanTrampos</code> </b>",
 'parse_mode'=>'HTML',
 'reply_markup' => $free,
 ]);
        exit();
...
'inline_keyboard' => [
[['text' => "OWNER", 'url' => "https://t.me/DeanTrampos"],]
]]);
...
// if(!in_array($chatId, $premiumgp)){
	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot5167022773:AAHblmq9U_tTg3uXXHR5Ehfd7yjJFpQJkS4/getChatMember?chat_id=@roldexverse&user_id=".$gId))->result->status;
...
// exit();
// }
        	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot5167022773:AAHblmq9U_tTg3uXXHR5Ehfd7yjJFpQJkS4/getChatMember?chat_id=@roldexversechats&user_id=".$gId))->result->status;
// if($tch != 'member' && $tch != 'creator' && $tch != 'administrator'){
// bot('sendMessage',['chat_id'=>$chatId,'reply_to_message_id'=>$message_id,'text'=>"Sorry <a href='tg://user?id=$gId'>$firstname</a>
// 
// You Need To Join My Update Channel To Get Regular Updates
// 
 // Made With ♥️ By @DeanTrampos And @RoldexVerse
// 
// USE /start AFTER JOIN",
 // 'parse_mode'=>'HTML',
 // 'reply_markup' =>  $keyboard1,
...
if(strpos($message, '!key') === 0 or strpos($message, '/key') === 0 or strpos($message, '.key') === 0){
    $keyboard = [
    'inline_keyboard' => [[['text' => 'Features', 'callback_data' => 'paid'], ['text' => 'Buy', 'callback_data' => 'buy'], ['text' => 'Buy Now', 'url' => 'https://t.me/DeanTrampos'],]]];
...
$link = mysqli_connect("localhost", "jv", "jvcraft199", "@");
...
function bot($method,$datas=[]){
    $url = "https://api.telegram.org/bot5167022773:AAHblmq9U_tTg3uXXHR5Ehfd7yjJFpQJkS4/".$method;
    $ch = curl_init();
...
<i>take group access from <code>@DeanTrampos</code> to use here</i></b>");
